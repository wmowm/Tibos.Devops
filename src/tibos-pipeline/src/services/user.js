import {LOGIN, ROUTES,GETAUTHORIZE,GITLABLOGIN,CREATEUSERLOGIN,GETUSERLOGIN,UPDATEUSERINFO,UPDATEUSERSTATUS,GETUSERINFOLIST,GETROLES,UPDATEUSERPWD,GETUSERTEAMLIST,GETUSERPROJECTLIST,GETFAVORITEAPPLIST,GETUSERINFO} from '@/services/api'
